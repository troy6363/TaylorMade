...
const outputCode = `const PRODUCTS = ${JSON.stringify(PRODUCTS, null, 2)};\n\nif (typeof module !== 'undefined' && module.exports) {\n  module.exports = PRODUCTS;\n}\n`;
fs.writeFileSync('products.js', outputCode);
console.log(`Generated ${PRODUCTS.length} clean products inside products.js!`);
